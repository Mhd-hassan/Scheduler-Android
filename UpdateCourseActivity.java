...
import android.content.Intent; // Work Of this is to start an activity, lunch an activity, such as action view,etc
import android.os.Bundle; // A mapping from String keys to various values
import android.view.View; // A View occupies a rectangular area on the screen and is responsible for drawing and event handling.
import android.widget.Button; // A user interface element the user can tap or click to perform an action.
...
import androidx.appcompat.app.AppCompatActivity; // Base class for activities that wish to use some of the newer platform features on older Android devices.
